...
<main class="scan-page" :data-run-id="data?.run_id??''">
  <header><div><small>INTRADAY RESEARCH</small><h1>盘中策略观察</h1><p>九策略独立扫描 · 前瞻计划 · 原候选连续跟踪</p></div><a href="/research">返回研究台</a></header>
...
<style scoped>
.scan-page{max-width:1500px;margin:auto;padding:28px;color:#22334b;font:14px/1.6 'Segoe UI','Microsoft YaHei',sans-serif}header{display:flex;justify-content:space-between;align-items:center}h1{font-size:28px;margin:3px 0}header small{letter-spacing:2px;color:#8293aa}header p,.metadata,footer{color:#6f8097}a{color:#315fb2;text-decoration:none}button,select,input{font:inherit;border:1px solid #dce3ed;border-radius:7px;background:white;color:inherit;padding:8px 12px}button{cursor:pointer}.toolbar{display:flex;gap:12px;align-items:center;flex-wrap:wrap;margin:20px 0}.toolbar select{max-width:550px}.metrics{display:grid;grid-template-columns:repeat(4,1fr);gap:12px}.metrics div{padding:15px;background:white;border:1px solid #e1e7ef;border-radius:9px}.metrics small,.metrics strong{display:block}.metrics small{color:#7e8ca0}.metrics strong{font-size:16px;margin-top:8px}nav{display:flex;gap:7px;flex-wrap:wrap;margin:20px 0}.active{background:#274d80;color:white;border-color:#274d80}nav small{opacity:.75;margin-left:5px}.workspace{display:grid;grid-template-columns:325px minmax(0,1fr);gap:18px;align-items:start}.list,.detail{background:white;border:1px solid #e0e7ef;border-radius:10px;padding:18px}.list{max-height:980px;overflow:auto}.list input{width:100%;box-sizing:border-box}.list p{color:#79889c;font-size:12px}.stock{width:100%;display:flex;justify-content:space-between;text-align:left;border:0;border-bottom:1px solid #eff2f7;border-radius:0;padding:13px 6px}.stock small{display:block;font-size:11px;color:#7d8ba0}.stock.selected{background:#edf3fd;border-radius:6px}.stock>span:last-child{text-align:right}.detail h2{margin:0;font-size:22px}.detail h2 small{font-size:13px;color:#8390a3;font-weight:400}.conclusion{font-size:16px;color:#294d78}.prices{display:flex;gap:20px;flex-wrap:wrap;padding:12px 0;border-top:1px solid #edf0f5}.chart{height:340px;width:100%}.chart-controls{display:flex;gap:6px}.warning{background:#fff7e8;color:#856326;padding:10px;border-radius:5px}.error{background:#fff0ef;color:#b34848;padding:12px}footer{font-size:11px;margin-top:20px;overflow-wrap:anywhere}h3{font-size:15px;margin-bottom:5px}.metadata{font-size:12px;overflow-wrap:anywhere}@media(max-width:900px){.scan-page{padding:14px}.metrics{grid-template-columns:repeat(2,1fr)}.workspace{grid-template-columns:1fr}.list{max-height:320px}.toolbar select{max-width:100%}.detail{padding:12px}.chart{height:290px}}
