...
async function loadResearch() {
  ...
  try {
    ...
    const [outcomeData, scorecardData, messageData, skillData, analystResearchData] = await Promise.all([
    ...
    remoteMessages.value = messageData.items ?? []; analystSkills.value = skillData.items ?? []; analystResearchStatus.value = analystResearchData;
